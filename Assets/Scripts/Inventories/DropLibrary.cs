    ...
    public class DropLibrary : ScriptableObject
    {
        ...
        class DropConfig
        {
            ...
            public int GetRandomNumber(int level)
            {
                ...
                return UnityEngine.Random.Range(min, max + 1); // max + 1 because Random.Range doesnt include the max number.
            }
        }
        ...
        {
            return GetByLevel(dropChancePercentage, level) > UnityEngine.Random.Range(0,100);
        }
